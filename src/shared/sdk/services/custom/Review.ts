...
export class ReviewApi extends BaseLoopBackApi {
   ...
   * </em>
   */
  public getCoffeeShop(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
   ...
   * </em>
   */
  public getReviewer(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Reviews/:id/reviewer";
    let _routeParams: any = {
